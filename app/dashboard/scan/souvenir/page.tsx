...
export default function ScanSouvenirPage() {
  ...
  // Focus hidden input when dialog closes to keep scanner ready
  useEffect(() => {
    if (!dialogOpen) {
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="rounded-lg border bg-card p-3 sm:p-4">
        <div className="flex items-center justify-between">
          <div className="">
            <div className="text-sm font-medium mb-2">Scan QR Souvenir</div>
            <div className="text-xs text-muted-foreground mb-3">
              Data peserta yang telah mengambil souvenir.
            </div>
          </div>
