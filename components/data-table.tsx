...
function DragHandle({ id }: { id: number }) {
  ...
  return (
    ...
    >
      ...
      <span className="sr-only">Seret untuk mengurutkan</span>
    </Button>
  );
}
...
const columns: ColumnDef<z.infer<typeof schema>>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <Badge
        variant={row.original.status === "Done" ? "default" : "outline"}
        className="px-1.5"
      >
...
export function DataTable({
  ...
  return (
    <div className="@container/table grid gap-4">
      <DndContext
        id={sortableId}
        sensors={sensors}
            ...
            <>
              ...
              <div className="grid gap-2">
                ...
                <div className="text-muted-foreground">
                  Menampilkan total pengunjung untuk 6 bulan terakhir. Ini hanya
                  teks acak untuk menguji tata letak. Teks ini mencakup beberapa
                  baris dan harus membungkus.
                </div>
              </div>
              <Separator />
            </>
